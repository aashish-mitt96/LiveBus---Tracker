...
// Build the Route's Stop Sequence with Cummulative Distance along the Path.
...
// Project a lat/lon onto the Nearest Segment of the Route to get Distance along the Route.
